 ...
 * <p>
 * Modified by Niranjan Suri on 12/28/05 - changed code to add the
...
public class Base64Encoder
{
     ...
     *    the output stream.
     */
    public void processWithNewlines()
        throws IOException
    {
     ...
     *    the output stream.
     */
    public void processWithoutNewlines()
        throws IOException
    {
        byte buffer[] = new byte[BUFFER_SIZE];
        int got = -1;
    ...
    public Base64Encoder (String input)
    {
        ...
        try {
            ...
            throw new RuntimeException (this.getClass().getName() +
                                        "[Constructor] Unable to convert properly char to bytes");
        }
        this.stringp = true;
