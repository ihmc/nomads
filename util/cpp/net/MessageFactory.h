    ...
    class MessageFactory
        {
            public:
                ...
                NetworkMessage * getDataMessage (uint8 ui8MsgType, uint32 ui32SourceAddress, uint32 ui32TargetAddress, uint16 ui16MsgId,
                ...
                NetworkMessage * getReliableDataMessage (uint8 ui8MsgType, uint32 ui32SourceAddress, uint32 ui32TargetAddress,
                                                        uint8 ui8HopCount, uint8 ui8TTL, NetworkMessage::ChunkType chunkType,
                                                        const void *pMsgMetaData, uint16 ui16MsgMetaDataLen,
                                                        const void *pMsg, uint16 ui16MsgLen);
