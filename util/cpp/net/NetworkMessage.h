...
namespace NOMADSUtil
{
    ...
    class NetworkMessage
    {
        public:
            ...
            uint32 getSourceAddress (void) const;
            uint32 getTargetAddress (void) const;
    ...
    {
        return ((getSourceAddress() == rhsMessageInfo.getSourceAddress()) && (getMsgId() == rhsMessageInfo.getMsgId()));
    }

    inline bool NetworkMessage::operator > (NetworkMessage &rhsMessageInfo)
    {
        //return ((getSourceAddress() == rhsMessageInfo.getSourceAddress()) && (getMsgId() > rhsMessageInfo.getSourceAddress()) ? ((getMsgId() - rhsMessageInfo.getSourceAddress()) <= (32768UL)) : ((rhsMessageInfo.getSourceAddress() - getMsgId()) > (32768UL)));
        return ((getSourceAddress() == rhsMessageInfo.getSourceAddress()) && SequentialArithmetic::greaterThan(getMsgId(), rhsMessageInfo.getMsgId()));
    }
