                                          ...
                                          uint32 ui32DataLen)
{
    ...
    do {
        ...
        if (ui32Offset == ui32DataLen) {
            ...
            pRet = MessageFactory::createNetworkMessageFromFields (pNetMsg->getMsgType(), pNetMsg->getSourceAddress(),
                                                                   pNetMsg->getTargetAddress(), pNetMsg->getSessionId(),
...
{
    return ((_pNetMsg->getSourceAddress() == rhsMsgWrapper._pNetMsg->getSourceAddress()) &&
