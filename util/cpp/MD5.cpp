...
const char * MD5::PRINT_PATTERN = "%02x%02x%02x%02x"
                                  "%02x%02x%02x%02x"
                                  "%02x%02x%02x%02x"
                                  "%02x%02x%02x%02x";
...
const unsigned char * MD5::getChecksum (void)
{
    MD5Final (auchChecksum, &ctx);
    return auchChecksum;
}
...
char * MD5::getChecksumAsString (void)
{
    ...
    const unsigned char *pucMD5 = getChecksum();
    if (pucMD5 == NULL) {
        free (pszMD5);
        pszMD5 = NULL;
        return NULL;
    }
    sprintf (pszMD5, PRINT_PATTERN,
             pucMD5[0],  pucMD5[1],  pucMD5[2],  pucMD5[3],
             pucMD5[4],  pucMD5[5],  pucMD5[6],  pucMD5[7],
             pucMD5[8],  pucMD5[9],  pucMD5[10], pucMD5[11],
             pucMD5[12], pucMD5[13], pucMD5[14], pucMD5[15]);
...
char * MD5Utils::getMD5Checksum (Reader *pReader)
{
...
char * MD5Utils::getMD5Checksum (BufferWriter *pWriter)
{
