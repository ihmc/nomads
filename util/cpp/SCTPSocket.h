...
namespace NOMADSUtil
{
        ...
        typedef int (*SCTPSocketIdleCallbackFuncType) (void *pUserData);
    #endif
    ...
    class SCTPSocket : public Socket
    {
        public:
            ...
            virtual int isConnected(void);
                ...
                virtual int setIdleCallbackFunc (SCTPSocketIdleCallbackFuncType pFn, void *pUserData);
                                                   // NOTE: pUserData will be shared by all instances of SCTPSocket!
            #endif
        ...
        protected:
            ...
            String remoteHostName;
                ...
                static SCTPSocketIdleCallbackFuncType pIdleFn;
