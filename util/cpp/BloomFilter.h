...
namespace NOMADSUtil
{
    ...
    public:
        ...
        BloomParameters ()
            : minimum_size (1),
            maximum_size (ULLONG_MAX),
            minimum_number_of_hashes (1),
            maximum_number_of_hashes (UINT_MAX),
        ...
        inline bool operator!()
        {
            return (minimum_size > maximum_size) ||
                ...
                (((double)INFINITY) == abs (false_positive_probability)) ||
                (0 == random_seed) ||
        ...
        virtual bool compute_optimal_parameters ()
        {
            ...
            */
            ...
            while (k < 1000.0) {
                ...
                double denominator = log (1.0 - pow (false_positive_probability, 1.0 / k));
    ...
    public:
        ...
        compressible_bloom_filter (const BloomParameters& p)
            : BloomFilter (p)
        {
