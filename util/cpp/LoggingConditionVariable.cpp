...
#include "LoggingConditionVariable.h"
...
LoggingConditionVariable::LoggingConditionVariable (LoggingMutex *pMutex)
{
    _pMutex = pMutex;
    #if defined (WIN32)
...
LoggingConditionVariable::~LoggingConditionVariable (void)
{
    #if defined (WIN32)
...
int LoggingConditionVariable::wait (uint16 ui16LocationId)
{
    if (_pMutex == NULL) {
        return -1;
    }
        ...
        if (_pMutex->lock (ui16LocationId)) {
            return -3;
        }
    #elif defined (UNIX)
...
int LoggingConditionVariable::wait (uint16 ui16LocationId, int64 i64Millisec)
{
    if (_pMutex == NULL) {
        return -1;
    }
...
int LoggingConditionVariable::wait (uint16 ui16LocationId, int64 i64Millisec, bool *timedOut)
{
    int rc=0;
...
int LoggingConditionVariable::notify (uint16 ui16LocationId)
{
    if (_pMutex == NULL) {
        return -1;
    }
...
int LoggingConditionVariable::notifyAll (uint16 ui16LocationId)
{
    if (_pMutex == NULL) {
        return -1;
    }
