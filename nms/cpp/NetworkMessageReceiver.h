...
namespace NOMADSUtil
{
    ...
    class NetworkMessageReceiver : public NOMADSUtil::ManageableThread
    {
        public:
            ...
            NetworkMessageReceiver (NetworkInterfaceManagerListener *pListener, NetworkInterface *pNetIface, bool bReceive = true);
        ...
        protected:
            ...
            NetworkMessageReceiver (NetworkInterfaceManagerListener *pNMSParent, NetworkInterface *pNetIface,
