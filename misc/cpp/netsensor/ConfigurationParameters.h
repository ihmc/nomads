#ifndef INCL_NETSENSOR_CONFIGURATION_PARAMETERS_H
#define INCL_NETSENSOR_CONFIGURATION_PARAMETERS_H
...
#include "../../../util/cpp/FTypes.h"
#include "../../../util/cpp/StrClass.h"
#include "../../../util/cpp/net/NetworkHeaders.h"
...
namespace IHMC_MISC
{
	...
	static uint32 NETSENSOR_IP_ADDR;
	static uint32 NETSENSOR_NETWORK_NETMASK;
	static uint32 NETWORK_GATEWAY_NODE_IP_ADDR;
	//static const char * const pszNetworkAdapterNamePrefix;
	static const uint16 ETHERNET_MAXIMUM_MFS = 9038U;
#if defined (WIN32)
	const char * const pszNetworkAdapterNamePrefix = "\\Device\\NPF_";
#else
	const char * const pszNetworkAdapterNamePrefix = "";
#endif
