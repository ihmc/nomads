...
#ifndef PROTOBUF_INCLUDED_traffic_2eproto
#define PROTOBUF_INCLUDED_traffic_2eproto
...
namespace google {
namespace protobuf {
template<> ::netsensor::Average* Arena::CreateMaybeMessage<::netsensor::Average>(Arena*);
template<> ::netsensor::Microflow* Arena::CreateMaybeMessage<::netsensor::Microflow>(Arena*);
template<> ::netsensor::Stat* Arena::CreateMaybeMessage<::netsensor::Stat>(Arena*);
template<> ::netsensor::TrafficByInterface* Arena::CreateMaybeMessage<::netsensor::TrafficByInterface>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace netsensor {
...
class TrafficByInterface : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:netsensor.TrafficByInterface) */ {
 public:
  ...
  #if LANG_CXX11
  TrafficByInterface(TrafficByInterface&& from) noexcept
    : TrafficByInterface() {
    *this = ::std::move(from);
  }

  inline TrafficByInterface& operator=(TrafficByInterface&& from) noexcept {
  ...
  friend void swap(TrafficByInterface& a, TrafficByInterface& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline TrafficByInterface* New() const final {
    return CreateMaybeMessage<TrafficByInterface>(NULL);
  }

  TrafficByInterface* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<TrafficByInterface>(arena);
  }
...
class Microflow : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:netsensor.Microflow) */ {
 public:
  ...
  #if LANG_CXX11
  Microflow(Microflow&& from) noexcept
    : Microflow() {
    *this = ::std::move(from);
  }

  inline Microflow& operator=(Microflow&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(Microflow& a, Microflow& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline Microflow* New() const final {
    return CreateMaybeMessage<Microflow>(NULL);
  }

  Microflow* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<Microflow>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class Average : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:netsensor.Average) */ {
 public:
  ...
  inline Average* New() const final {
    return CreateMaybeMessage<Average>(NULL);
  }

  Average* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_traffic_2eproto
