...
const int64 C_CLEANING_TIME = 1000;
const int64 C_SLEEP_TIME    = 500;
...
const char * const C_DELIVERY_TIME            = "-period";
...
const char * const C_FORCED_ADRR              = "-faddr";
const char * const C_FORCED_NMSK              = "-fnmsk";
const char * const C_FORCED_INTERFACES        = "-fi";
const char * const C_ENABLE_IW                = "-iw";
...
const uint8 C_INT_DELIVERY_TIME               = 8;
const uint8 C_INT_FORCED_ADRR                 = 9;
const uint8 C_INT_FORCED_NMSK                 = 10;
const uint8 C_INT_FORCED_INTERFACES           = 11;
const uint8 C_INT_ENABLE_IW                   = 12;
