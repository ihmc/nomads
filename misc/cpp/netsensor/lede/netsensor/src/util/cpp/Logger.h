...
namespace NOMADSUtil
{
    ...
    class Logger
    {
        public:
            ...
            static const int DEFAULT_SPLUNK_LOGGING_PORT = 8089;
            ...
            int initSplunkLogging (const char *pszLocalHost, const char *pszSplunkSrvIPAddr, uint16 ui16SplunkSrvPort = DEFAULT_NETWORK_LOGGING_PORT);
            ...
            int enableSplunkOutput (unsigned char uchLevel);
            void disableSplunkOutput (void);
        ...
        protected:
            ...
            uint16 _ui16SplunkSrvPort;
            UDPDatagramSocket *_pDGSocket;
            String _splunkSrvIPAddr;
            String _localHost;
