...
namespace NOMADSUtil
{
    ...
    class LList
    {
        public:
            ...
            */
             ...
             */
             int replace (const T &elOld, const T &elNew);
            ...
            Copy operator, returns value by reference
             ...
             @Return: Copied List
             */
             virtual LList<T> & operator = (const LList<T> &SourceList);
    ...
    template <class T> void LList<T>::add (const T &el)
    {
    ...
    template <class T> int LList<T>::getCount (void) const
    {
        Node *pTempNode;
        int iCount = 0;
    ...
    template <class T> int LList<T>::remove (const T &el)
    {
        int iResult = 0;
    ...
    template <class T> int LList<T>::replace (const T &elOld, const T &elNew)
    {
        int iResult = 0;
        Node *pTempNode;
    ...
    template <class T> int LList<T>::search (T &el) const
    {
        Node *pTempNode;
        int iFound;
    ...
    template <class T> LList<T> & LList<T>::operator = (const LList<T> &SourceList)
    {
        Node *pTempNode;
