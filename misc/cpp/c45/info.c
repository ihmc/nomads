...
/*    -----------  */
{
    ...
    // Compute total info after split, by summing the info of each of the subsets formed by the test
    ForEach(v, 1, MaxVal) {
    ...
    Verbosity(1) printf("ComputeThisGain: items %.1f info %.3f base %.3f unkn %.3f result %.3f\n",
