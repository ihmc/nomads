...
namespace IHMC_MISC
{
    ...
    class Spike
    {
        ...
        private:
            bool spikeStatus (bool spiking, int64 i64CurrROTT, int64 i64MinROTT, int64 i64MaxROTT);
    ...
    class ZBS
    {
        public:
            ...
            LossType packetArrived (LinkState linkState, LossType mbiaz, LossType spike, LossType zigzag);
    };
}
