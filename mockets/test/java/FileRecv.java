...
public class FileRecv
{
    public static void main (String[] args) throws Exception
    {
        ...
        int dataMTU = MessageMocket.getMaximumMTU();
        ...
        if (!useSockets) {
            System.out.println ("FileRecv: creating MessageServerMocket");
            ...
            System.out.println ("FileRecv: MessageServerMocket accepted a connection");
            ...
            while (true) {
                ...
                if ((i = mocket.receive (buffer, 0, (int)bytesToRead)) >= 0) {
                    ...
                    System.out.println ("FileRecv: received " + i + " bytes (" + bytesRead + 
