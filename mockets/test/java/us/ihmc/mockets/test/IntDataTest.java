...
public class IntDataTest
{
    ...
    {
        public ServerMessageMocketThread (ServerMocket msm)
        {
        ...
        public void run()
        {
            ...
            while (true) {
                try {
                    ...
                    Mocket msgMocket = _msgServerMocket.accept();
    ...
    {
        public ConnHandler (Mocket msgMocket)
        {
        ...
        public void run()
        {
            try {
                ...
                if (_useMsgMockets) {
                    Mocket.Sender sender = _msgMocket.getSender (true, true);
        ...
        public void run()
        {
            ...
            try {
                ...
                if (_useMsgMockets) {
                    ...
                    //_msgMocket.setStatusListener (this);
     ...
     *
     */
    public synchronized static void saveStats (Mocket msgMocket, String type, long txTime)
    {
    ...
    public static void main (String[] args) throws Exception
    {
        ...
        if (args[0].equals ("server")) {
            ServerMocket msm = new ServerMocket (portNumber);
            System.out.println ("AdHocTest :: created a ServerMocket on port " + portNumber);
