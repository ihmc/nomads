/*
 * Benchmark to evaluate the throughput of mockets and tcp sockets - client side
 */
...
public class BenchmarkThroughputDataSend
{
...
//                    System.out.println ("sent "+bytesSent+" bytes");
    ...
    private static final long DATA_SIZE = 10 * MEGA_BYTE;
    private static final int REMOTE_PORT = 4000;
    private static final int ARRAY_LEN = 1370;
