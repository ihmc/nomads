/**
 * The UnsequencedQueueTest class is a testcase for the 
* UnsequencedPacketQueue class.
 *
...
public class UnsequencedQueueTest extends TestCase
{
    public static Test suite() 
    {
        return new TestSuite (UnsequencedQueueTest.class);
    } 
    ...
    public void test1() throws Exception
    {
        ...
        int elements = 3;
        Iterator it = upq.iterator();
        while (it.hasNext()) {
            it.remove();
            assertEquals ("test1 iter wrong", --elements, upq.packetsInQueue());
        }
        
        //upq.dump (System.err);
        assertEquals ("test1 4 wrong", 0, upq.packetsInQueue());
    }
}
