/**
 * The ReliableUnsequencedRecompositionTest class is a testcase for the 
...
public class ReliableUnsequencedRecompositionTest extends TestCase
{
    public static Test suite() 
    {
        return new TestSuite (ReliableUnsequencedRecompositionTest.class);
    } 
    ...
    public void test1() throws Exception
    {
        ...
        mp1.addChunk (d1);
        mp1.setFlags (MessagePacket.HEADER_FLAG_RELIABLE |
        ...
        mp2.addChunk (d2);
        mp2.setFlags (MessagePacket.HEADER_FLAG_RELIABLE |
                      MessagePacket.HEADER_FLAG_MORE_FRAGMENTS);
        ...
        mp3.addChunk (d3);
        mp3.setFlags (MessagePacket.HEADER_FLAG_RELIABLE |
    ...
    public void test2a() throws Exception
    {
        ...
        assertEquals ("test2a 4 wrong", 2, upq.packetsInQueue());
    }
    ...
    public void test4a() throws Exception
    {
        ...
        assertEquals ("test4a 4 wrong", 2, upq.packetsInQueue());
    }
    ...
    public void test6a() throws Exception
    {
        ...
        assertEquals ("test6a 3 wrong", 1, upq.packetsInQueue());
    }
    ...
    public void test7a() throws Exception
    {
        ...
        assertEquals ("test7a 3 wrong", 1, upq.packetsInQueue());
    }
    ...
    public void test8a() throws Exception
    {
        ...
        assertEquals ("test8a 4 wrong", 2, upq.packetsInQueue());
    }
}
