/**
 * The UnreliableSequencedRecompositionTest class is a testcase for the 
 * unreliable sequenced fragment recomposition performed by the 
...
public class UnreliableSequencedRecompositionTest extends TestCase
{
    public static Test suite() 
    {
        return new TestSuite (UnreliableSequencedRecompositionTest.class);
    } 
    ...
    public void test2a() throws Exception
    {
        ...
        MessagePacketProcessor mpp = new MessagePacketProcessor (new MessageMocket(),
                                                                 0, 0, neTSN);
        long newTSN = mpp.tryToProcessFirstPacketFromSequencedQueue (spq, neTSN, false);
        long expectedResult = SequentialArithmetic.add (neTSN, 2);
        ...
        newTSN = mpp.tryToProcessFirstPacketFromSequencedQueue (spq, newTSN, false);
        expectedResult = SequentialArithmetic.add (neTSN, 3);
    ...
    public void test3a() throws Exception
    {
        ...
        MessagePacketProcessor mpp = new MessagePacketProcessor (new MessageMocket(),
                                                                 0, 0, neTSN);
        long newTSN = mpp.tryToProcessFirstPacketFromSequencedQueue (spq, neTSN, false);
        long expectedResult = SequentialArithmetic.add (neTSN, 1);
        ...
        assertEquals ("test3a 2 neTSN wrong", expectedResult, newTSN);
        assertEquals ("test3a 2 spq.neTSN wrong", expectedResult, spq.getNextExpectedTSN());
    }
