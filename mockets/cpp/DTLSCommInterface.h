...
public:
    ...
    */
    ...
    virtual int sendTo(NOMADSUtil::InetAddr *pRemoteAddr, const void *pBuf, int iBufSize, const char *pszHints = NULL);
	...
	//virtual int getAndResetDtlsObject(IHMC_DTLS::DtlsEndpoint** dtls);
private:
