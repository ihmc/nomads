...
void xpath_processor::v_build_root ()
{
   if (XNp_base)
   {
      ...
      if (! XNp_base_parent)
         ...
         #if !defined (ANDROID) //No support for -fexceptions on ANDROID
   ...
   bool o_skip_only)             ///< True if we only need to skip rules and not act on the data stack
{
   ...
   switch (xc_action)
   {
      ...
      default :
        ...
        #else
            printf("TinyXPath: execution error 12");
        #endif    
   }
}
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (S_name == "true")
      ...
      #else
          printf("TinyXPath execution error 13");
      #endif
}
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 1)
    ...
    #else
      printf("TinyXPath execution error 14");
    #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (! u_nb_arg)
    ...
    #else
      printf("TinyXPath execution error 15");
    #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 2)
    ...
    #else
      printf("TinyXPath execution error 16");
    #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (! u_nb_arg)
    ...
    #else
      printf("TinyXPath execution error 17");
    #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   if (u_nb_arg)
    ...
    #else
      printf("TinyXPath execution error 18");
    #endif
   v_push_bool (false);
}
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 1)
    ...
    #else
      printf("TinyXPath execution error 19");
    #endif
   switch (erpp_arg [0] -> e_type)
   {
      case e_int :
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg)
    ...
    #else
      printf("TinyXPath execution error 20");
    #endif
   ...
   if (! XEp_context)
    ...
    #else
      printf("TinyXPath execution error 21");
    #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   switch (u_nb_arg)
   {
      ...
      default :
        ...
        #else
            printf("TinyXPath execution error 22");
        #endif
   }
   v_push_string (S_res);
}
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 1)
        ...
        #else
            printf("TinyXPath execution error 23");
        #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   if (u_nb_arg != 1)
        ...
        #else
            printf("TinyXPath execution error 24");
        #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg)
        ...
        #else
            printf("TinyXPath execution error 25");
        #endif
   XEp_context = XEp_get_context ();
   if (! XEp_context)
      #if !defined (ANDROID) //No support for -fexceptions on ANDROID
        ...
        #else
            printf("TinyXPath execution error 26");
        #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 2)
        ...
        #else
            printf("TinyXPath execution error 27");
        #endif
   S_arg_1 = erpp_arg [0] -> S_get_string ();
   S_arg_2 = erpp_arg [1] -> S_get_string ();
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 1)
        ...
        #else
            printf("TinyXPath execution error 28");
        #endif
   S_arg = erpp_arg [0] -> S_get_string ();
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 2 && u_nb_arg != 3)
        ...
        #else
            printf("TinyXPath execution error 29");
        #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 1)
        ...
        #else
            printf("TinyXPath execution error 30");
        #endif
   i_sum = 0;
   d_sum = 0.0;
   o_out_double = false;
   if (erpp_arg [0] -> e_type != e_node_set)
        ...
        #else
            printf("TinyXPath execution error 31");
        #endif
   nsp_set = erpp_arg [0] -> nsp_get_node_set ();
   assert (nsp_set);
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg)
        ...
        #else
            printf("TinyXPath execution error 38");
        #endif
   XEp_context = XEp_get_context ();
   if (! XEp_context)
        #if !defined (ANDROID) //No support for -fexceptions on ANDROID
        ...
        #else
            printf("TinyXPath execution error 39");
        #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   ...
   if (u_nb_arg != 3)
        ...
        #else
            printf("TinyXPath execution error 40");
        #endif
   ...
   expression_result ** erpp_arg)   ///< Argument list
{
   if (u_nb_arg)
        ...
        #else
            printf("TinyXPath execution error 32");
        #endif
   v_push_bool (true);
}
...
void xpath_processor::v_function_equal_2_node (expression_result * erp_node_set_, expression_result * erp_node_set_2)
{
        ...
        throw error_not_yet ();
    #else
        printf("TinyXPath not yet implemented");
    #endif
      ...
      switch (u_sub)
      {
         ...
         case xpath_multiplicative_expr_div :
            if (fabs (d_arg_2) < 1.0e-6)
               ...
               #else
                    printf("TinyXPath execution error 33");
               #endif
            d_res = d_arg_1 / d_arg_2;
            break;
         case xpath_multiplicative_expr_mod :
