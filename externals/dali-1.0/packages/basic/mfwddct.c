...
#define FIX(x)  ((long) ((x) * DCT_SCALE + 0.5))
...
#define FIXO(x)  ((long) ((x) * DCT_SCALE / OVERSCALE + 0.5))
    ...
    short *data;
{
     ...
     */
        ...
        inptr = data;           /* initialize pointers for first pass *///short*

    outptr = workspace;         //short*
    ...
    for (pass = 1; pass >= 0; pass--) {
        for (rowctr = DCTSIZE - 1; rowctr >= 0; rowctr--) {
            ...
            tmp0 = inptr[7] + inptr[0];         // inptr = first row of data2d
            ...
            outptr[0] = (short) UNFIXH((tmp10 + tmp11) * SIN_1_4);
            outptr[DCTSIZE * 4] = (short) UNFIXH((tmp10 - tmp11) * COS_1_4);

            outptr[DCTSIZE * 2] = (short) UNFIXH(tmp13 * COS_1_8 + tmp12 * SIN_1_8);
            outptr[DCTSIZE * 6] = (short) UNFIXH(tmp13 * SIN_1_8 - tmp12 * COS_1_8);
            ...
            outptr[DCTSIZE] = (short) UNFIXH(tmp17 * OCOS_1_16 + tmp14 * OSIN_1_16);
            outptr[DCTSIZE * 7] = (short) UNFIXH(tmp17 * OCOS_7_16 - tmp14 * OSIN_7_16);
            outptr[DCTSIZE * 5] = (short) UNFIXH(tmp26 * OCOS_5_16 + tmp25 * OSIN_5_16);
            outptr[DCTSIZE * 3] = (short) UNFIXH(tmp26 * OCOS_3_16 - tmp25 * OSIN_3_16);
