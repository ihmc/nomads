...
====================================================================================================================== 
These are custom and unsupported, pre-built OpenSSL Libraries v1.0.2h (http://www.openssl.org). 
They are compiled with Cygwin/MSVC for 32/64-bit Windows, using Visual Studio 2013. 
