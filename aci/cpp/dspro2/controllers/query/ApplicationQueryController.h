...
#ifndef INCL_APPLICATION_QUERY_CONTROLLER_H
#define INCL_APPLICATION_QUERY_CONTROLLER_H
...
namespace IHMC_ACI
{
    ...
    {
        public:
            ApplicationQueryController (DSProImpl *pDSPro, DataStore *pDataStore, InformationStore *pInfoStore);
            ~ApplicationQueryController (void);
...
#endif  // INCL_APPLICATION_QUERY_CONTROLLER_H
