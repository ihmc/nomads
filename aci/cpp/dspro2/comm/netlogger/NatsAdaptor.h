...
#ifndef INCL_NATS_ADAPTOR_H
#define INCL_NATS_ADAPTOR_H
...
namespace IHMC_ACI
{
    class NatsAdaptor : public CommAdaptor, public IHMC_MISC_NATS::NatsWrapper::Listener
    {
        public:
            static const unsigned short DEFAULT_PORT;

            NatsAdaptor (unsigned int uiId, CommAdaptorListener *pListener,
        ...
        private:
            IHMC_MISC_NATS::NatsWrapper _nats;
    };
}


#endif  /* INCL_NET_LOGGER_ADAPTOR_H */
