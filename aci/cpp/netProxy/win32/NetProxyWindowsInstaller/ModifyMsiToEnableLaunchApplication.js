...
var checkboxText = "Launch [ProductName] to test the tap interface installation and configuration";     // Text for the checkbox on the finished dialog
var filename = "NetProxy.exe";                     // The name of the executable to launch - change * to match the file name you want to launch at the end of your setup
...
var scriptPath = scriptFullPath.replace(WScript.ScriptName,"");

var filespec = scriptPath.concat(WScript.Arguments(0));
var installer = WScript.CreateObject("WindowsInstaller.Installer");
WScript.Echo("Installer file: " + filespec);
...
try
{
        ...
        sql = "INSERT INTO `CustomAction` (`Action`, `Type`, `Source`, `Target`) VALUES ('VSDCA_Launch', '210', '" + fileId + "', '-testtap')";
        view = database.OpenView(sql);
        view.Execute();
        view.Close();
