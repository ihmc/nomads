 ...
 */
public class NetConnectivityMonitor extends AsyncProvider implements FGraphEventListener
{
    public void init()
            throws Exception
    {
        ...
        _maxConnDistance = cloader.getPropertyAsDouble("netConnMonitor.maxConnDistance", _maxConnDistance);
    ...
    /**
     * NOTE THA THIS METHODS WILL REMOVE THE REACHIBILITY EDGES IF IT FINDS MORE THAN ONE
     */
