...
/**
 * Creates an instance of the <code>Radial1Square</code> gauge
 * @author Rita Lenzi (rlenzi@ihmc.us)
 */
public class Radial1SquareGauge implements Gauge
{
    @Override
    ...
    private final Radial1Square _gauge = new Radial1Square();
}
