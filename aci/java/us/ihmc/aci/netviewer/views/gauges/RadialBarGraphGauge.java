...
/**
 * Creates an instance of the <code>RadialBargraph</code> gauge
 * @author Rita Lenzi (rlenzi@ihmc.us)
 */
public class RadialBarGraphGauge implements Gauge
{
    @Override
    ...
    private final RadialBargraph _gauge = new RadialBargraph();
}
