...
/**
 * Creates an instance of the <code>RadialCounter</code> gauge
 * @author Rita Lenzi (rlenzi@ihmc.us)
 */
public class RadialCounterGauge implements Gauge
{
    @Override
    ...
    private final RadialCounter _gauge = new RadialCounter();
}
