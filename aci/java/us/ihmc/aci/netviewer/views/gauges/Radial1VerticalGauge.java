...
/**
 * Creates an instance of the <code>Radial1Vertical</code> gauge
 * @author Rita Lenzi (rlenzi@ihmc.us)
 */
public class Radial1VerticalGauge implements Gauge
{
    @Override
    ...
    private final Radial1Vertical _gauge = new Radial1Vertical();
}
