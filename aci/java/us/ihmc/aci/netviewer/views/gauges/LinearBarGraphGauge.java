...
/**
 * Creates an instance of the <code>LinearBargraphGauge</code> gauge
 * @author Rita Lenzi (rlenzi@ihmc.us)
 */
public class LinearBarGraphGauge implements Gauge
{
    @Override
    ...
    private final LinearBargraph _gauge = new LinearBargraph();
}
