...
/**
 * Creates an instance of the <code>DigitalRadial</code> gauge
 * @author Rita Lenzi (rlenzi@ihmc.us)
 */
public class DigitalRadialGauge implements Gauge
{
    @Override
    ...
    private final DigitalRadial _gauge = new DigitalRadial();
}
