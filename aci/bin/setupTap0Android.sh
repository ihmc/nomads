...
/system/xbin/tunctl -d tap0 > null
/system/xbin/tunctl -f /dev/tun -u $USER -t tap0
/system/xbin/ifconfig tap0 down
/system/xbin/ifconfig tap0 hw ether 02:0a:0c:00:$MAC1:$MAC2
/system/xbin/ifconfig tap0 "$IP_STRING" netmask $SNMASK_STRING
/system/xbin/ifconfig tap0 up
